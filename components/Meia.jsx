...
export default function PizzaItem({item, navigation, params}){
    let pizza = params.pizza;
    let tamanho = params.tamanho;
    let metade = params.metade;
    let darkTheme = params.darkTheme;
    ...
    onPress={()=> navigation.navigate("adicionaisPage", {meia: item, pizza, tamanho, metade, darkTheme})}
    > 
      <View style={styles.containerPai}>
        ...
        <View>
          ...
          <Text style={textStyle}>Valores: R${item.precos[0].p} a R${item.precos[3].gg}</Text>
        </View>
      </View>
      
      <Text style={ingredientesStyle}>
